...
class ViewController2 : UIViewController{
    ...
    override func viewDidLoad() {
        ...
        self.paramEmail.textAlignment = NSTextAlignment.center//가운데 정렬
        self.paramEmail.adjustsFontSizeToFitWidth = true //입력된 문자열의 길이와 텍스트 필드의 너비에 따라 폰트사이즈가 다르게 적용
        self.paramEmail.placeholder = "placeholder -> 안드에서 힌트속성"
        self.paramEmail.autocapitalizationType = .none // 첫글자 대문자 자동변환 기능을 해제하는 코드
        ...
        self.paramInterval.minimumValue = 0 //1.스테퍼가 가질수있는 최소값
        ...
        //스테퍼의 값을 텍스트로 표현할 레이블 추가
        self.txtInterval = UILabel()
        self.txtInterval.frame = CGRect(x: 255, y: 200, width: 100, height: 30)
        ...
        */
        ...
        /*
        배경이미지 바둑판처럼 나열하는 코드
        let image = UIImage(contentsOfFile:"SampleImage.png")!
